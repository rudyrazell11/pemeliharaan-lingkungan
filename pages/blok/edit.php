                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_blok" value="<?= $item['nama_blok'] ?>" id="nama_blok">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="id_komplek" id="id_komplek" class="form-control">
                                    ...
                                    <?php foreach ($data_komplek as $key => $komplek) : ?>
                                        <option <?php if ($komplek['id_komplek'] == $item['id_komplek']) : ?> selected <?php endif; ?> value="<?= $komplek['id_komplek'] ?>"><?= $komplek['nama_komplek'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
